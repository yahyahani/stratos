          ...
          {messages.length === 0 && (
            <div className="flex flex-col items-center text-center pt-14 pb-8 animate-fade-in">
              ...
              <div className="relative mb-6">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 flex items-center justify-center text-2xl shadow-[0_0_32px_rgba(99,102,241,0.35)]">
                  🤖
                </div>
